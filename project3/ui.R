    ...
    mainPanel((tabBox(
      ...
      tabPanel('Fit Statistics',
        ...
        box(withSpinner(verbatimTextOutput('rfRMSE')), title = 'Random Forest Fit on Training Data', 
            width = 12),
        box(withSpinner(verbatimTextOutput('rfRMSE2')), title = 'Random Forest Fit on Test Data', 
            width = 12),
        box(withSpinner(verbatimTextOutput('boostRMSE')), title = 'Boost Fit on Training Data', 
            width = 12),
        box(withSpinner(verbatimTextOutput('boostRMSE2')), title = 'Boost Fit on Test Data', 
            width = 12)
      ),
      tabPanel("Summary",
        ...
        box(withSpinner(verbatimTextOutput('linPredSum')), width = 6, title = 'Summary of linear pred')
      ),
      tabPanel("Plots",
